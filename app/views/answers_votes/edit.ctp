...
<?php echo $this->Form->create('AnswersVote');?>
	<fieldset>
 		<legend><?php __('Edit Answers Vote'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('AnswersVote.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('AnswersVote.id'))); ?></li>
