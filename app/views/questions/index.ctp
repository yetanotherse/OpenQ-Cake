...
<?php
	$this->Paginator->options(array(
		...
		'evalScripts' => true,
		'before' => $this->Js->get('#questions-top')->effect('slideOut', array('buffer' => false)),
		'success' => $this->Js->get('#questions-top')->effect('slideIn', array('buffer' => false))
	));
?>
<div class="submenu">
        <h2><?php __('All Questions');?></h2>
	<ul class="tabs">
		...
		<div id="question-preview-<?php echo $question['Question']['id'];?>" class="question-preview">
			<div class="qpreview-stats">
				<div class="qpreview-votes">
					<strong><?php echo $qhelper->current_count($question['QuestionsVote']); ?></strong> <div id="preview-votes">votes</div>
				</div>	
